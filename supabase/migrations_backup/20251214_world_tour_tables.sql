...
DROP POLICY IF EXISTS "Anyone can submit tour requests" ON tour_requests;
CREATE POLICY "Anyone can submit tour requests" ON tour_requests
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Admins can view tour requests" ON tour_requests;
...
DROP POLICY IF EXISTS "Admins can update tour requests" ON tour_requests;
...
DROP POLICY IF EXISTS "Anyone can view dream organizations" ON dream_organizations;
CREATE POLICY "Anyone can view dream organizations" ON dream_organizations
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Admins can manage dream organizations" ON dream_organizations;
...
DROP POLICY IF EXISTS "Anyone can view tour stops" ON tour_stops;
CREATE POLICY "Anyone can view tour stops" ON tour_stops
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Admins can manage tour stops" ON tour_stops;
...
DROP TRIGGER IF EXISTS tour_requests_updated_at ON tour_requests;
...
DROP TRIGGER IF EXISTS dream_organizations_updated_at ON dream_organizations;
