-- Minimal ACT Integration - Only create what's missing
...
CREATE TABLE IF NOT EXISTS act_projects (
  ...
  display_config JSONB DEFAULT '{"max_storytellers": 5, "max_stories": 3, "auto_approve_storytellers": false, "auto_approve_stories": false}'::jsonb,
...
-- =====================================================
-- VIEW: Featured Storytellers (using actual column names)
-- =====================================================
...
SELECT
  ...
  u.raw_user_meta_data->>'profile_image_url' AS featured_image_url,
  spf.opted_in_at,
  spf.approved_at,
  spf.created_at,
  spf.updated_at
