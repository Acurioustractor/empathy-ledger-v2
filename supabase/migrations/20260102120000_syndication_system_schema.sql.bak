...
-- Indexes
CREATE INDEX idx_syndication_sites_tenant ON syndication_sites(tenant_id);
...
CREATE TABLE IF NOT EXISTS syndication_consent (
  ...
  requested_by UUID REFERENCES auth.users(id), -- Who made the request
...
CREATE INDEX idx_syndication_consent_tenant ON syndication_consent(tenant_id);
...
CREATE INDEX idx_story_distributions_tenant ON story_distributions(tenant_id);
...
CREATE INDEX idx_storyteller_payouts_tenant ON storyteller_payouts(tenant_id);
...
ALTER TABLE syndication_sites ENABLE ROW LEVEL SECURITY;
ALTER TABLE syndication_consent ENABLE ROW LEVEL SECURITY;
ALTER TABLE embed_tokens ENABLE ROW LEVEL SECURITY;
ALTER TABLE story_distributions ENABLE ROW LEVEL SECURITY;
ALTER TABLE syndication_engagement_events ENABLE ROW LEVEL SECURITY;
ALTER TABLE syndication_webhook_events ENABLE ROW LEVEL SECURITY;
ALTER TABLE revenue_attributions ENABLE ROW LEVEL SECURITY;
ALTER TABLE storyteller_payouts ENABLE ROW LEVEL SECURITY;
ALTER TABLE media_vision_analysis ENABLE ROW LEVEL SECURITY;
...
GRANT SELECT, INSERT, UPDATE ON syndication_consent TO authenticated;
GRANT SELECT ON syndication_sites TO authenticated;
GRANT SELECT ON story_distributions TO authenticated;
GRANT SELECT ON syndication_engagement_events TO authenticated;
GRANT SELECT ON storyteller_payouts TO authenticated;
GRANT SELECT ON media_vision_analysis TO authenticated;
