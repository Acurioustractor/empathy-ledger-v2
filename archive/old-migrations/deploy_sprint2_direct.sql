-- Deploy Sprint 2 Migrations Directly
-- This script runs the migrations and marks them as applied

BEGIN;

-- ============================================================================
-- Execute Migration 1: Stories Sprint 2 Fields
-- ============================================================================
...
-- ============================================================================
-- Execute Migration 2: Media Assets Sprint 2 Fields
-- ============================================================================
...
VALUES
  ('20260104000001', 'stories_sprint2_fields'),
  ('20260104000002', 'media_assets_sprint2_fields')
...
SELECT 'Media assets columns:' as info;
SELECT column_name, data_type, is_nullable
FROM information_schema.columns
