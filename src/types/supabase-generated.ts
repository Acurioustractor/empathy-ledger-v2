  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["elder_id"]
            isOneToOne: false
            referencedRelation: "campaign_workflow_dashboard"
            referencedColumns: ["storyteller_id"]
          },
          {
            foreignKeyName: "ai_moderation_logs_elder_id_fkey"
            columns: ["elder_id"]
          ...
          },
          {
            ...
            columns: ["elder_id"]
            isOneToOne: false
            referencedRelation: "v_storyteller_revenue_summary"
            referencedColumns: ["storyteller_id"]
          },
        ]
      }
      ...
      campaign_consent_workflows: {
        Row: {
          ...
          tenant_id: string
          updated_at: string | null
          withdrawal_handled_by: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "campaign_consent_workflows_elder_reviewed_by_fkey"
          ...
          {
            foreignKeyName: "campaign_consent_workflows_story_id_fkey"
            columns: ["story_id"]
            isOneToOne: false
            referencedRelation: "campaign_workflow_dashboard"
            referencedColumns: ["story_id"]
          ...
          {
            foreignKeyName: "campaign_consent_workflows_storyteller_id_fkey"
            columns: ["storyteller_id"]
            isOneToOne: false
            referencedRelation: "campaign_workflow_dashboard"
            referencedColumns: ["storyteller_id"]
      ...
      campaigns: {
        Row: {
          ...
          description: string | null
          dream_organization_ids: string[] | null
          ...
          requires_consent_workflow: boolean | null
          requires_elder_review: boolean | null
          slug: string
          ...
          story_target: number | null
          storyteller_target: number | null
          tagline: string | null
          tenant_id: string
      ...
      knowledge_documents: {
        Row: {
          ...
          farmhand_attributes: Json | null
          id: string
          knowledge_type: string
          last_updated: string | null
          metrics: Json | null
          pmpp_attributes: Json | null
          source_file: string
      ...
      knowledge_extractions: {
        ...
        Relationships: [
          {
            foreignKeyName: "knowledge_extractions_chunk_id_fkey"
            columns: ["chunk_id"]
            isOneToOne: false
      ...
      knowledge_graph: {
        ...
        Relationships: [
          {
            foreignKeyName: "knowledge_graph_source_chunk_id_fkey"
          ...
          {
            foreignKeyName: "knowledge_graph_target_chunk_id_fkey"
      ...
      media_assets: {
        Row: {
          ...
          description: string | null
          detected_people_ids: string[] | null
          ...
          requires_consent_from: string[] | null
          search_vector: unknown
          source_type: string | null
          ...
          visibility: string | null
          vision_analysis_completed: boolean | null
          width: number | null
        }
        Insert: {
          alt_text?: string | null
      ...
      media_vision_analysis: {
        Row: {
          approved_for_syndication: boolean | null
          claude_analysis_at: string | null
          claude_analysis_completed: boolean | null
          claude_cost_usd: number | null
          claude_cultural_protocols: string[] | null
          claude_cultural_sensitivity_score: number | null
          claude_elder_review_required: boolean | null
          claude_recommended_restrictions: string | null
          claude_sacred_content_detected: boolean | null
          created_at: string
          cultural_permission_level: string | null
          detected_people: Json | null
          face_matching_completed: boolean | null
          face_matching_consent_required_from: string[] | null
          id: string
          media_asset_id: string
          openai_analysis_at: string | null
          openai_analysis_completed: boolean | null
          openai_confidence_score: number | null
          openai_content_flags: string[] | null
          openai_cost_usd: number | null
          openai_cultural_markers: string[] | null
          openai_faces_detected: number | null
          openai_objects_detected: string[] | null
          openai_scene_description: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "media_vision_analysis_media_asset_id_fkey"
            columns: ["media_asset_id"]
            isOneToOne: true
            referencedRelation: "media_assets"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "media_vision_analysis_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenant_analytics"
            referencedColumns: ["tenant_id"]
      ...
      profiles: {
        Row: {
          ...
          is_community_representative: boolean | null
          ...
          representative_bio: string | null
          representative_community: string | null
          representative_metadata: Json | null
          representative_role: string | null
          representative_verified_at: string | null
          representative_verified_by: string | null
          requires_elder_review: boolean | null
      ...
      revenue_attributions: {
        ...
        Relationships: [
          {
            foreignKeyName: "revenue_attributions_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "syndication_sites"
            referencedColumns: ["id"]
          },
          {
      ...
      stories: {
        Row: {
          ...
          enable_ai_processing: boolean | null
          excerpt: string | null
          ...
          syndication_excerpt: string | null
          tags: string[] | null
          tenant_id: string
          themes: Json | null
          title: string
          total_syndication_revenue: number | null
          traditional_knowledge_flag: boolean | null
          transcript_id: string | null
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "campaign_dashboard_summary"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "stories_campaign_id_fkey"
      ...
      storyteller_payouts: {
        Row: {
          ...
          tax_form_received: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "storyteller_payouts_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenant_analytics"
            referencedColumns: ["tenant_id"]
      ...
      syndication_consent: {
        Row: {
          ...
          allow_excerpt_only: boolean | null
          allow_full_content: boolean | null
          allow_media_assets: boolean | null
          approved_at: string | null
          created_at: string
          cultural_permission_level: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "syndication_consent_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "syndication_sites"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "syndication_consent_story_id_fkey"
            columns: ["story_id"]
            isOneToOne: false
            referencedRelation: "campaign_workflow_dashboard"
            referencedColumns: ["story_id"]
          ...
          {
            foreignKeyName: "syndication_consent_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenant_analytics"
            referencedColumns: ["tenant_id"]
      ...
      syndication_engagement_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "syndication_engagement_events_distribution_id_fkey"
            columns: ["distribution_id"]
            isOneToOne: false
            referencedRelation: "story_distributions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "syndication_engagement_events_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "syndication_sites"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "syndication_engagement_events_story_id_fkey"
            columns: ["story_id"]
            isOneToOne: false
            referencedRelation: "campaign_workflow_dashboard"
            referencedColumns: ["story_id"]
          ...
          {
            foreignKeyName: "syndication_engagement_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenant_analytics"
            referencedColumns: ["tenant_id"]
      ...
      syndication_sites: {
        Row: {
          ...
          description: string
          id: string
          max_stories_per_request: number | null
          name: string
        ...
        Relationships: [
          {
            foreignKeyName: "syndication_sites_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenant_analytics"
            referencedColumns: ["tenant_id"]
      ...
      syndication_webhook_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "syndication_webhook_events_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "syndication_sites"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "syndication_webhook_events_story_id_fkey"
            columns: ["story_id"]
            isOneToOne: false
            referencedRelation: "campaign_workflow_dashboard"
            referencedColumns: ["story_id"]
          ...
          {
            foreignKeyName: "syndication_webhook_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenant_analytics"
            referencedColumns: ["tenant_id"]
      ...
      tour_stops: {
        ...
        Relationships: [
          {
            foreignKeyName: "tour_stops_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "campaign_dashboard_summary"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      campaign_dashboard_summary: {
        ...
        Insert: {
          ...
          name?: string | null
          participant_count?: number | null
          pending_publication?: never
          published_count?: never
          slug?: string | null
          start_date?: string | null
          status?: string | null
          story_count?: number | null
          story_progress?: never
          story_target?: number | null
          storyteller_progress?: never
          storyteller_target?: number | null
          tenant_id?: string | null
          updated_at?: string | null
          workflow_count?: number | null
    ...
    Functions: {
      ...
      advance_workflow_stage: {
        Args: { p_new_stage: string; p_notes?: string; p_workflow_id: string }
        Returns: {
          campaign_id: string | null
          consent_form_url: string | null
          consent_granted_at: string | null
      ...
      delete_storyteller_ai_data: {
        Args: { storyteller_id_param: string }
        Returns: undefined
      }
      diag:
        | {
      ...
      generate_campaign_slug: { Args: { p_name: string }; Returns: string }
      generate_descript_embed: {
        Args: { height?: string; video_id: string; width?: string }
        Returns: string
      }
      generate_test_embed_token: {
        Args: { p_site_slug: string; p_story_id: string }
        Returns: string
      }
      ...
      get_campaign_details: { Args: { p_campaign_id: string }; Returns: Json }
      get_campaign_workflow_summary: {
        Args: { p_campaign_id?: string; p_tenant_id?: string }
        Returns: Json
      }
      get_community_representatives: {
        Args: { p_community?: string; p_role?: string; p_tenant_id?: string }
        Returns: {
          avatar_url: string
          display_name: string
          id: string
          representative_bio: string
          representative_community: string
          representative_metadata: Json
          representative_role: string
          representative_verified_at: string
          story_count: number
        }[]
      }
      get_database_schema: {
      ...
      get_knowledge_base_stats: {
        ...
        Returns: {
          ...
          cultural_safety_coverage: number
      ...
      search_knowledge: {
        Args: {
          ...
          filter_cultural_sensitivity?: string[]
          match_count?: number
