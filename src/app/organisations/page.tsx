...
export default function OrganizationsPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      setLoading(false)
      console.log('⏰ Organizations loading timeout - continuing anyway')
    }, 3000)
  ...
  useEffect(() => {
    filterOrganizations()
  }, [searchTerm, selectedType, organisations])
  ...
  const fetchOrganizations = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setFilteredOrgs(data.organisations || [])
      } else {
        console.error('❌ Organizations API error:', response.status, response.statusText)
        // Continue anyway, show empty list instead of hanging
        setOrganizations([])
        setFilteredOrgs([])
      }
    } catch (error) {
      ...
      <div className="container mx-auto px-4 py-12">
                ...
                <CardContent>
                  ...
                  <div className="flex gap-2">
                    <Button 
                      ...
                      onClick={(e) => {
                        e.stopPropagation()
                        router.push(`/organisations/${org.id}/dashboard`)
                      }}
                    >
                      View Details
        ...
        <div className="mt-16 text-center bg-white rounded-lg shadow-lg p-8 max-w-3xl mx-auto">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button 
              variant="outline"
              onClick={() => window.open('/docs/organisations', '_blank')}
            >
              Learn More
            </Button>
          </div>
