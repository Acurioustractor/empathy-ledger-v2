...
import OrganizationContextManager from '@/components/organization/OrganizationContextManager'
import {
  Settings,
  Building2,
  Users,
...
export default async function SettingsPage({ params }: SettingsPageProps) {
  ...
  const { organisation, memberCount, canEdit } = await getOrganizationSettings(id)
      ...
      <Tabs defaultValue="general" className="w-full">
        ...
        <TabsContent value="context" className="space-y-6 mt-6">
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold mb-2">Organization Context</h3>
              <p className="text-sm text-muted-foreground">
                Define your organization's mission, values, and impact approach to enable project-specific analysis and better AI insights.
              </p>
            </div>
