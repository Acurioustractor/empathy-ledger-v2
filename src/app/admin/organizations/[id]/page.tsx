                ...
                <CardContent className="space-y-4">
                  ...
                  {organization.mission_statement && (
                    <div>
                      ...
                      <p className="mt-1">{organization.mission_statement}</p>
                    </div>
                  )}
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-4 bg-green-50 rounded-lg">
                      ...
                      <div className="text-2xl font-bold">{organization.story_count || 0}</div>
          ...
          <TabsContent value="members" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {organization.member_count || 0} members associated with this organization
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="stories" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {organization.story_count || 0} stories from this organization
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8 text-gray-500">
          ...
          <TabsContent value="settings" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage organization configuration and permissions</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8 text-gray-500">
