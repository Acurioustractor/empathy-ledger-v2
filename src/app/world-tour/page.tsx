...
import {
  ...
  Mic, BookOpen, UserCircle, Compass
} from 'lucide-react'
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <Typography variant="h2" className="text-3xl md:text-4xl font-bold mb-4">
              Where Stories Are Waiting
            </Typography>
            <Typography variant="body-lg" className="text-muted-foreground">
              Explore confirmed tour stops, community nominations, and dream partner locations
              around the world. Click any marker to learn more.
            </Typography>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">Confirmed Stops</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-full bg-clay-500"></div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-sage-50/50 via-background to-sky-50/30 dark:from-sage-950/10 dark:via-background dark:to-sky-950/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <DreamOrganizations organizations={mapData.dreamOrgs} loading={loading} />
        </div>
      </section>
