...
export default async function SettingsPage({ params }: SettingsPageProps) {
  const { organization, memberCount } = await getOrganizationSettings(params.id)
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {organization.cultural_protocols ? (
              <div>
                <label className="text-sm font-medium">Active Protocols</label>
                <div className="mt-2 space-y-2">
                  {Object.entries(organization.cultural_protocols as Record<string, any>).map(([key, value]) => (
            ...
            <div>
              ...
              <div className="mt-1">
                <Badge variant="outline">
                  {organization.privacy_level || 'Standard'}
                </Badge>
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>
              This organization dashboard provides read-only access to your community data.
