      ...
      <Card className="h-full flex flex-col shadow-2xl border-2 border-orange-200">
        ...
        <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-orange-50 to-orange-100">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-semibold text-stone-900">Support & Help</h3>
          </div>
                  ...
                  <div className="space-y-4 p-2">
                      ...
                      >
                        <div className={`max-w-[80%] ${
                          message.type === 'user' 
                            ...
                            : message.type === 'bot'
                            ? 'bg-sage-50 text-stone-900 border rounded-r-lg rounded-tl-lg'
                            : 'bg-green-50 text-stone-900 border rounded-r-lg rounded-tl-lg'
                        } p-3`}>
                          <div className="flex items-start gap-2">
                            {message.type !== 'user' && (
                              <Avatar className="w-6 h-6">
                                <AvatarFallback className="bg-stone-100 text-xs">
                    ...
                    {isTyping && (
                      <div className="flex justify-start">
                        <div className="bg-stone-100 rounded-r-lg rounded-tl-lg p-3">
                          <div className="flex items-center gap-1">
                ...
                <ScrollArea className="h-full">
                  <div className="space-y-4 p-2">
                    <div className="text-center py-4">
                      ...
                      <p className="text-sm text-stone-600">Quick answers to common questions</p>
                    </div>

                    <div className="space-y-3">
                      <Card className="p-3 cursor-pointer hover:bg-stone-50">
                        <div className="flex items-start gap-3">
                          <FileText className="w-5 h-5 text-sage-600 mt-0.5" />
                          <div>
                            <h4 className="font-medium text-sm">How to publish a story</h4>
                            <p className="text-xs text-stone-600">Step-by-step guide for story creation</p>
                          </div>
                        </div>
                      </Card>
                      ...
                      <Card className="p-3 cursor-pointer hover:bg-stone-50">
                        <div className="flex items-start gap-3">
                          <Video className="w-5 h-5 text-clay-600 mt-0.5" />
                          <div>
                            <h4 className="font-medium text-sm">Managing your media</h4>
                            <p className="text-xs text-stone-600">Upload and organise photos and videos</p>
                          </div>
                        </div>
                      </Card>
                      ...
                      <Card className="p-3 cursor-pointer hover:bg-stone-50">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-stone-600">Update your information and preferences</p>
                          </div>
                        </div>
                      </Card>
                      ...
                      <Card className="p-3 cursor-pointer hover:bg-stone-50">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-stone-600">Using AI to help write your stories</p>
                          </div>
                        </div>
                      </Card>
                      ...
                      <div className="border-t pt-3 mt-4">
                        <div className="text-center">
                          <p className="text-xs text-stone-600 mb-3">Still need help?</p>
