...
const statusOptions = [
  ...
  { value: 'public', label: 'Public', colour: 'bg-sage-100 text-sage-800' },
  { value: 'private', label: 'Private', colour: 'bg-clay-100 text-clay-800' },
  ...
  { value: 'inactive', label: 'Inactive', colour: 'bg-stone-100 text-stone-800' },
